    ...
    return (
        ...
        <div className=" border-2 border-stone-400   " >
            <form className="card-body " onSubmit={formik.handleSubmit}>
                  ...
                  {/* Name */}
                   ...
                   {/* Password */}
                    <div className="form-control flex flex-row items-center gap-4 mb-5 ml-9">
                        ...
                        {/* Phone */}
                        <div className="form-control flex flex-row items-center gap-4  ml-[63px] ">
                ...
                <div className=" pl-32" >
                    <button type="submit" className=" px-5 py-3 rounded-md shadow-xl hover:bg-[#06ac3a] hover:scale-105 bg-[#099635] text-white font-bold">Add Pharmacist</button>
                </div>
            </form>
        </div>
    </div>
