...
<div className="card shadow-xl  bg-base-200 mx-auto border-[#0D2E4E] border mt-5 w-6/6 md:w-4/6 lg:w-2/6 relative">
    ...
    <div className="flex items-center md:px-4 px-1  py-1 bg-red-100 border border-red-600 rounded-lg">
        ...
        <Link to="/" className='flex items-center hover:bg-gradient-to-r from-[#1e6fc0] to-[#0D2E4E] hover:text-white gap-1 text-[#0D2E4E] bg-white font-semibold lg:text-3xl md:text-2xl text-xl border-2 border-[#0D2E4E] p-2 rounded-xl' ><BsCalendar2Check /> <p>Make A Request</p> </Link>
