...
<div className="relative h-[500px] mt-20 mb-10 flex items-center justify-center">
      ...
      <div className="relative z-10  md:flex  items-center max-sm:top-12  lg:gap-[300px] md:gap-[50px] text-white p-6 ">
        ...
        <div className="grid grid-cols-4 md:grid-cols-2  lg:gap-20 md:gap-10 p-5 text-xl font-extralight ">
          <div>
            <p className="lg:text-8xl font-normal text-4xl md:text-6xl">214k</p>
            <p className="lg:text-2xl md:text-xl text-sm font-semibold ">Satisfied Customers</p>
            
          </div>
          <div>
            <p className="lg:text-8xl font-normal text-4xl md:text-6xl">12+</p>
            <p className="lg:text-2xl md:text-xl text-sm font-semibold ">Winning Awards</p>
            
          </div>
          <div>
            <p className="lg:text-8xl font-normal text-4xl md:text-6xl">15+</p>
            <p className="lg:text-2xl md:text-xl text-sm font-semibold ">Helping Partners</p>
            
          </div>
          <div>
            <p className="lg:text-8xl font-normal text-4xl md:text-6xl">05+</p>
            <p className="lg:text-2xl md:text-xl text-sm font-semibold ">Years of Experience</p>
