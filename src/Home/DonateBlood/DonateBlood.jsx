...
<div className="relative py-12 bg-gradient-to-r from-red-500 via-pink-500 to-red-600 text-white">
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
    ...
    <Link to="/" className="inline-block bg-white border-2 text-red-600 font-bold py-3 px-6 rounded-full text-lg transition hover:bg-gradient-to-r from-pink-700 to-rose-600 hover:text-white hover:border-pink-700 hover:border-2  ">
