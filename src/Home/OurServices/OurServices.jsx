...
const OurServices = () => {
  ...
  <div className="grid grid-cols-2 lg:grid-cols-4 md:gap-8 gap-4 px-7 md:px-4 text-justify">
    ...
    <Link to="" className=" bg-gradient-to-r from-blue-300 to-blue-500 hover:scale-105 md:p-6 p-4 rounded-lg shadow-md text-center">
      <img src="https://i.ibb.co.com/jwRHKMy/Doctor.png" alt="Healthcare Providers" className="md:w-32 w-20 mx-auto md:mb-4 mb-1"/>
    ...
    <Link to="" className=" bg-gradient-to-r from-yellow-200 to-yellow-500  hover:scale-105 md:p-6 p-4 rounded-lg shadow-md text-center">
      <img src="https://i.ibb.co.com/4PkMzC7/Ambulance.png" alt="Ambulance Services" className="md:w-32 w-20 mx-auto md:mb-4 mb-1"/>
    ...
    <Link to="" className="  bg-gradient-to-r from-green-300 to-green-600 hover:scale-105 md:p-6 p-4 rounded-lg shadow-md text-center">
      <img src="https://i.ibb.co.com/BKZQPSK/Pharmacy.png" alt="MediEquip & Supplies" className="md:w-32 w-20 mx-auto md:mb-4 mb-1"/>
 ...
 hover:scale-105 md:p-6 p-4 rounded-lg shadow-md text-center">
      <img src="https://i.ibb.co.com/n7TPBrY/Blood.png" alt="Blood Bank" className="md:w-32 w-20 mx-auto md:mb-4 mb-1"/>
