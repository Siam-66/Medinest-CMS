...
<div className="container mx-auto md:px-[100px] items-center justify-center flex-col text-justify mb-10">


    <div className=" md:flex justify-center items-center gap-[10px] mt-20 mb-20">
        <div className="lg:px-20 px-5 ">
            <h2 className="text-4xl  font-semibold text-[#0D2E4E]">About MediNest</h2>
            <h2 className="text-2xl  mt-8 font-semibold text-[#0D2E4E]">Who we are</h2>
        ...
        MediNest is an online healthcare platform connecting doctors, patients, clinics, and hospitals. Our services include doctor appointments, emergency care, and domiciliary care at home.
            ...
            <h2 className="text-2xl mt-8 font-semibold text-[#0D2E4E]">Our Mission</h2>
            <p className="mt-2 text-lg md:text-xl text-gray-600">
        Our mission is to provide a reliable healthcare solution. MediNest is run by professionals involved in medical research, committed to improving healthcare accessibility in Bangladesh.
            ...
            <h2 className="text-2xl mt-8 font-semibold text-[#0D2E4E]">Our Vision</h2>
            <p className="mt-2 text-lg md:text-xl text-gray-600">
            MediNest aims to be the Countries no.1 trusted healthcare provider, offering medical solutions right at your fingertips.
            </p>
            <div className="flex justify-center items-center mt-[50px] max-sm:mb-5 " >
                <a href="" className='text-[#0D2E4E] font-semibold md:text-3xl text-2xl border-[#0D2E4E] border-2 py-3 px-10 rounded-2xl'>Learn More About Us</a>
            </div>
            
        </div>
        <div className="">
            <img src="https://i.ibb.co.com/689n5j2/about0.jpg" alt="Healthcare Image 1" className="md:w-[1600px] rounded-lg shadow-lg" />
        </div>
    </div>


    <div className="lg:px-20 md:flex justify-center items-center gap-[50px]">
        ...
        <div className="lg:pl-[80px] px-5">
            ...
            <div className="flex justify-center items-center mt-[50px] " >
                <a href="" className='text-[#0D2E4E] font-semibold md:text-3xl text-2xl border-[#0D2E4E] border-2 py-3 px-10 rounded-2xl'>See Our Specialized Services</a>
            </div>
        </div>
