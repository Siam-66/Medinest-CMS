...
const DiagnosticReport = () => {
    return (
        ...
        <div >
          ...
          <span><TfiMenuAlt></TfiMenuAlt></span> <Link to="diagnosticReportList">Diagnostic Report List</Link>
            </div>
            <div className="flex items-center gap-2 text-white py-2 px-3 text-lg font-semibold border-b-2 border-white ">
            <samp><FaPlus /></samp><Link to="addDiagnosticReport">Add Diagnostic Report</Link>
            </div>
